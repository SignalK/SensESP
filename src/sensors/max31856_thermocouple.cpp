...
MAX31856Thermocouple::MAX31856Thermocouple(int8_t cs_pin, int8_t mosi_pin, int8_t miso_pin, int8_t clk_pin, int8_t drdy_pin, max31856_thermocoupletype_t  tc_type, uint read_delay, String config_path) :
    NumericSensor(config_path), data_ready_pin{drdy_pin}, read_delay{read_delay} {
  load_configuration();
