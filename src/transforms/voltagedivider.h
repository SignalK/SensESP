 ...
 *
 * Here, the output is the voltage across the fixed resistor (R2) between the junction and ground
 * and the variable resistor is connected between Vin and the junction.
 *
 * R2 is selected on the basis of the range of values for R1 and the maximum input voltage 
 * for the MCU's analog input.
 */
