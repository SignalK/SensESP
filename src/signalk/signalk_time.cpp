...
SignalKTime::SignalKTime(String sk_path, String config_path) :
...
JsonObject& SignalKTime::get_configuration(JsonBuffer& buf) {
...
String SignalKTime::get_config_schema() {
  return FPSTR(SCHEMA);
}

bool SignalKTime::set_configuration(const JsonObject& config) {
