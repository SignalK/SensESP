...
The easiest way to interact with your device is using the SensESP web user interface.  Simply go to:

    http://sensesp.local

and you can select from the various options to configure your device.    
